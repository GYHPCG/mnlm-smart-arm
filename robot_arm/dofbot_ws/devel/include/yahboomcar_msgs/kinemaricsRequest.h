...
struct kinemaricsRequest_
{
  ...
  _kin_name_type kin_name;
   ...
   typedef std::vector<double, typename ContainerAllocator::template rebind<double>::other >  _src_pos_type;
  _src_pos_type src_pos;

   typedef std::vector<double, typename ContainerAllocator::template rebind<double>::other >  _src_joints_type;
